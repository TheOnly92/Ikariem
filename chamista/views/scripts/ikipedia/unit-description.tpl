		...
		<div class="content"> 
			<div id="unit" class="s{$unitDescription.sid}"> 
				<div id="unitRes"> 
					<ul class="resources"> 
						...
						<li class="weight fifthpos" title="Transport weight"><span class="textLabel">'Transport weight': </span>{$unitDescription.weight|number_format}</li> 
			...
			<div id="infoBox"> 
				...
				<div class="infoBoxContent"> 
					...
					<span class="textLabel">Armor:</span><b>{if $unitDescription.armor > 0}{$unitDescription.armor}{else}-{/if}</b><br/> 
					...
					<span class="{if $unitDescription.requirements.barracks.required > $unitDescription.requirements.barracks.user}notAvailable{else}available{/if}">* <a href="?view=buildingDetail&buildingId=6">Barracks ( {$unitDescription.requirements.barracks.required} )</a></span>
