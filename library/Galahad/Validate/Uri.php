...
class Galahad_Validate_Uri extends Zend_Validate_Abstract {
	 ...
	 * @var array
	 */
	protected $_messageTemplates = array (self::INVALID => "Invalid type given, value should be a string", self::INVALID_FORMAT => "'%value%' is no valid URI in the basic format http://domain.tld" );
